...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    labels_path = os.path.join(data_dict["path"],"val","labels")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/ICAFusion/models/transformer/yolov5l_custom_CSSA_FLIR.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/home/ICAFusion/data/multispectral/custom.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='/home/ICAFusion/data/hyp.scratch_VEDAI.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=60)
    parser.add_argument('--batch-size', type=int, default=8, help='total batch size for all GPUs')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640,512], help='[train, test] image sizes')
