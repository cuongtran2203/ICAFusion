...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/ICAFusion/runs/train/exp26/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='/home/ICAFusion/data/multispectral/custom.yaml', help='*.data path')
    ...
    p = "/home/RGB_IR_dataset/test/labels"
